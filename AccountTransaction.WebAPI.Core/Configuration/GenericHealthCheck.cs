using AccountTransaction.Core.Utils;
using AccountTransaction.WebAPI.Core.DatabaseFlavor;
using EasyNetQ;
...
using static AccountTransaction.WebAPI.Core.DatabaseFlavor.ProviderConfiguration;

namespace AccountTransaction.WebAPI.Core.Configuration
{
    public static class GenericHealthCheck
    {
            ...
            IConfiguration configuration)
        {
            ...
            string? rabbitConnStr = configuration.GetMessageQueueConnection("MessageBus");
